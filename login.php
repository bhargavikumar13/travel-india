        ...
        <div id="header" align="right">
            ...
            <div class="login-form">
                <table class="login-form-header">
                    <tr>
                        <td>
                            <strong>Sign In to Travel India</strong>
                        </td>
                    </tr>
                </table>
                <hr/>
            ...
            <?php
                ...
                <form method="POST" action="login.php">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td >
                                <input type="submit" style="color:white; background-color: #2e6da4; border-radius: 10px; width: 100%; font-size: 12px; padding: 10px;" value="Log In"></input>
                            </td>
                        </tr>
                    </table></form>';
                } else {
